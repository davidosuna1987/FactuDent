...
@section('content')
	...
	<div class="columns">
		<div class="column">
			...
			<div class="title">Editar clínica</div>
			<hr>
		</div>
	</div>
	...
	<div class="columns">
		<div class="column">
			...
			<form class="form" method="POST" action="{{route('clinics.update', $clinic)}}" role="form">
			    {{csrf_field()}}
			    {{method_field('PUT')}}
			    ...
			    <div class="columns">
			    	...
			    	<div class="column p-b-0">
			    		<div class="field{{ $errors->has('phone') ? ' has-error' : '' }}">
			    		    ...
			    		    <p class="control has-icons-left">
			    		        <input id="phone" type="text" class="input is-small{{ $errors->has('phone') ? ' is-danger' : ' is-primary' }}" name="phone" value="{{$clinic->phone or old('phone')}}">
			    	...
			    	<div class="column p-b-0">
			    		<div class="field{{ $errors->has('fax') ? ' has-error' : '' }}">
			    		    ...
			    		    <p class="control has-icons-left">
			    		        <input id="fax" type="text" class="input is-small{{ $errors->has('fax') ? ' is-danger' : ' is-primary' }}" name="fax" value="{{$clinic->fax or old('fax')}}">
			    ...
			    <div class="control is-pulled-right">
			        ...
			        <button type="submit" class="button is-primary m-t-10">Guardar clínica</button>
			    </div>
			</form>
		</div>
	</div>
