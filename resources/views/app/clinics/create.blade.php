			    ...
			    <div class="columns">
			    	...
			    	<div class="column is-one-third">
			    		<div class="field{{ $errors->has('post_code') ? ' has-error' : '' }}">
			    		    ...
			    		    <p class="control has-icons-left">
			    		        <input id="post_code" type="text" class="input is-small{{ $errors->has('post_code') ? ' is-danger' : ' is-primary' }}" name="post_code" value="{{old('post_code')}}">
			    ...
			    <div class="columns">
			    	...
			    	<div class="column p-b-0 w-150">
			    		<div class="field{{ $errors->has('percentage') ? ' has-error' : '' }}">
			    		    ...
			    		    <p class="control has-icons-left">
			    		        <input id="percentage" type="number" class="input is-small{{ $errors->has('percentage') ? ' is-danger' : ' is-primary' }}" name="percentage" min="1" max="100" value="{{(old('percentage') !== null) ? old('percentage') : (auth()->user()->default_percentage) ? auth()->user()->default_percentage : 50}}" >
